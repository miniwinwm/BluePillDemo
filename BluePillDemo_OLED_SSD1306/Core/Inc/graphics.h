...
/**
 * Initialize the OLED module. Call once and first.
 */
void GraphicsInit(void);

/**
 * Send the contents of the off-screen buffer to the display
 */
void GraphicsUpdateDisplay(void);
 ...
 */
void GraphicsMonochromeBitmap(int16_t x, int16_t y, uint16_t width, uint16_t height, const uint8_t *imageData);
