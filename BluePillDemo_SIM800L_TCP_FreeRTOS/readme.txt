...
USART2 and then the HTTP connection is closed. You need to set you Access point Name, 
user name (if any) and password (if any) for your SIM at the top of main.c.
