#ifndef INC_BUFFERED_SERIAL2_H_
#define INC_BUFFERED_SERIAL2_H_
 ...
 */
uint16_t serial2_write_data(uint16_t length, const uint8_t *data);
 ...
 */
uint16_t serial2_send_bytes_space(void);
