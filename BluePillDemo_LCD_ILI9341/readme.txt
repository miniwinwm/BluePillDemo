This example provides sample code for a TFT LCD display with a ILI9341 driver chip driving a 
2.8" 240 x 320 pixel display via a full duplex SPI interface. These panels are readily 
available on ebay at low cost. The colour depth is 16 bit in 565 format.

The code is separated into 3 layers. The lowest layer is the ILI9341 driver that uses the HAL
to access the SPI1 peripheral. This is in files ili9341.h/c. Above that is a graphics 
